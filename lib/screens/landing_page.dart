...
import 'package:tic_tac_toe/screens/offline_menu_page.dart';
import 'package:tic_tac_toe/screens/online_menu_page.dart';
          ...
          Column(
            ...
            children: <Widget>[
              ...
              buildPlayButton(
                ...
                () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => OfflineMenuPage()));
                },
              ),
              SizedBox(
                height: height * 0.04,
              ...
              buildPlayButton(
                ...
                () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => OnlineMenuPage()));
                },
              ),
            ],
          ),
